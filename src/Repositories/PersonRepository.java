...
public class PersonRepository implements IPersonRepository {
    ...
    private static final String DELETE_PERSON_SQL = "UPDATE Person SET Name = 'Deleted Models.Person' WHERE Id = ?";
    ...
    public Person readPersonByName(String name) throws SQLException {
        ...
        // if the name in "Deleted Models.Person" return null
        if (name.equals("Deleted Models.Person")) {
            return null;
        }
