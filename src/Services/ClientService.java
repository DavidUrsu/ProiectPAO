    ...
    public void addClient(String name) {
        try {
            ...
            if (personRepository.readPersonByName(name) == null) {
                System.out.println("Models.Person does not exist.");
                throw new InvalidClientException("Models.Person does not exist.");
            }
            // check is the person is a client
            if (clientRepository.getClientByName(name) != null) {
                System.out.println("Models.Person is already a client.");
                throw new InvalidClientException("Models.Person is already a client.");
            }
    ...
    public void setClientActiveByBadgeNumber(int badgeNumber, boolean isActive) {
        ...
        try {
            if (clientRepository.getClientByBadgeNumber(badgeNumber) == null) {
                System.out.println("Models.Client does not exist.");
                throw new InvalidClientException("Models.Client does not exist.");
            }
