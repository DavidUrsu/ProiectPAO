...
import Exceptions.InvalidBorrowOperationException;
import Exceptions.InvalidClientException;
import Models.Book;
import Models.BorrowOperation;
import Models.Client;
import Repositories.IBookRepository;
import Repositories.IBorrowOperationRepository;
    ...
    public void addBorrowOperation(int clientId, int bookId) {
        try{
            ...
            if (isBookBorrowed(bookId)) {
                throw new InvalidBookException("Models.Book is already borrowed");
            }
