...
import Repositories.BorrowOperationRepository;
import Repositories.ClientRepository;
import Repositories.PersonRepository;
import Services.BookService;
import Services.BorrowOperationService;
...
public class Library {
    ...
    public void showAllBooks() {
        ...
        for (Book book : books) {
            ...
            builder.append("Models.Book id: ").append(book.getId()).append("\n");
    ...
    public void showAllClients() {
        ...
        for (Client client : clients) {
            ...
            builder.append("Models.Person Id: ").append(client.getId()).append("\n");
    ...
    // Models.BorrowOperation methods
    ...
    public void showAllBorrowsByClientId(int clientId) {
        ...
        builder.append("Models.Client: ").append(client.getName()).append("\n");
        builder.append("Badge number: ").append(client.getBadgeNumber()).append("\n");
        ...
        for (BorrowOperation borrowOperation : borrowOperations) {
            ...
            builder.append("Models.Book: ").append(book.getTitle()).append("\n");
